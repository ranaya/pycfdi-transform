...
class Nomina11Handler (xml.sax.ContentHandler, Base32Handler, Base33Handler):
    def __init__(self):
    ...
    def startElement(self, tag, attrs):
        ...
        elif (tag == 'nomina:Nomina'):
            self.__transform_nomina11(tag, attrs)
        elif (tag == 'nomina:Percepciones'):
            self.__transform_nomina11_percepciones(tag, attrs)
        elif (tag == 'nomina:Percepcion'):
            self.__transform_nomina11_percepcion(tag, attrs)
        elif (tag == 'nomina:HorasExtra'):
            self.__transform_horas_extra(tag, attrs)
        elif (tag == 'nomina:JubilacionPensionRetiro'):
            self.__transform_jubilacion_pension_retiro(tag, attrs)
        elif (tag == 'nomina:Deducciones'):
            self.__transform_nomina11_deducciones(tag, attrs)
        elif (tag == 'nomina:Deduccion'):
            self.__transform_nomina11_deduccion(tag, attrs)
        elif (tag == 'nomina:Incapacidad'):
            self.__transform_incapacidad(tag, attrs)
        elif (tag == 'nomina:OtroPago'):
            self.__transform_otro_pago(tag, attrs)
        elif (tag == 'nomina:SubsidioAlEmpleo'):
            self.__transform_subsidio_causado(tag, attrs)
        elif (tag == 'nomina:CompensacionSaldosAFavor'):
    ...
    def __transform_nomina11(self, tag, attrs):
        ...
        if ('CLABE' in attrs):
            self._cuenta_bancaria = attrs['CLABE']
    ...
    def __transform_nomina11_percepciones(self, tag, attrs):
    ...
    def __transform_nomina11_percepcion(self, tag, attrs):
    ...
    def __transform_incapacidad(self, tag, attrs):
        ...
        if ('Descuento' in attrs):
            self._d006_importe_monetario = attrs['Descuento']
